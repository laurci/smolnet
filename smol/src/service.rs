...
impl Service {
    ...
    fn stash(&self, control: &str, token: &str, device: &str) -> Result<(), Box<dyn Error>> {
...
mod platform {
    ...
    impl Service {
        pub fn install(&self, control: &str, token: &str, device: &str) -> Result<(), Box<dyn Error>> {
...
mod platform {
    ...
    impl Service {
        pub fn install(&self, _: &str, _: &str, _: &str) -> Result<(), Box<dyn Error>> {
